...
python $SCRIPT_DIR/generate.py case57 -n 15 -s $SCRIPT_DIR/train  >/dev/null
echo "Generatingfrom case89pegase"
python $SCRIPT_DIR/generate.py case89pegase -n 15 -s $SCRIPT_DIR/train  >/dev/null
echo "Generating from case118"
python $SCRIPT_DIR/generate.py case118 -n 15 -s $SCRIPT_DIR/train  >/dev/null
echo "Generating from case145"
python $SCRIPT_DIR/generate.py case145 -n 15 -s $SCRIPT_DIR/train  >/dev/null
echo "Generating from case_illinois200"
python $SCRIPT_DIR/generate.py case_illinois200 -n 15 -s $SCRIPT_DIR/train  >/dev/null
echo "Generating from case300"
python $SCRIPT_DIR/generate.py case300 -n 15 -s $SCRIPT_DIR/train  >/dev/null
echo "Generating from case1354pegase"
python $SCRIPT_DIR/generate.py case1354pegase -n 15 -s $SCRIPT_DIR/train  >/dev/null
echo "Generating from case1888rte"
python $SCRIPT_DIR/generate.py case1888rte -n 15 -s $SCRIPT_DIR/train  >/dev/null
echo "Generating from case2848rte"
python $SCRIPT_DIR/generate.py case2848rte -n 15 -s $SCRIPT_DIR/train  >/dev/null
