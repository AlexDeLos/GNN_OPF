...
class ResGated(nn.Module):
    ...
    def __init__(
        ...
        self.convs.append(ResGatedGraphConv(in_channels=input_dim, out_channels=hidden_conv_dim, edge_dim=edge_attr_dim))
        for _ in range(n_hidden_conv):
            self.convs.append(ResGatedGraphConv(in_channels=hidden_conv_dim, out_channels=hidden_conv_dim, edge_dim=edge_attr_dim))

        if self.no_lin:
            self.convs.append(ResGatedGraphConv(hidden_conv_dim, output_dim, edge_dim=edge_attr_dim))
