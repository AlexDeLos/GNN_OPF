...
def main():
    csv_dict = {
        ...
        'physics_loss_-1' : 'Data/results/physics_1_results.csv',
        'physics_loss_-2' : 'Data/results/physics_2_results.csv',
        'physics_loss_-3' : 'Data/results/physics_3_results.csv',
        'physics_loss_-10' : 'Data/results/physics_10_results.csv',
        'physics_loss_-15' : 'Data/results/physics_15_results.csv',
        'physics_loss_-20' : 'Data/results/physics_20_results.csv',
    }
