...
class GINE(torch.nn.Module):
    ...
    def __init__(self, input_dim, output_dim, edge_dim, hidden_gine_dim=16, hidden_lin_dim=46, dropout_rate=0.21712495130712664, jumping_knowledge=True, n_of_convs_in=8):
